<?php 
if (get_post_meta($post->ID, "pimp_link", true) == 1) { ?>
<div class="albumInfosWrapper">
	...
	<div class="albumInfosRight">
		...
		<div class="albumLinks">
			...
			<h3>Liens</h3>
			<?php if ($linkWebsite != "") { ?>
				<a href="<?php echo $linkWebsite; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/website-32x32.png" alt="Website" /></a>&nbsp;
			<?php } ?>
			<!-- Social -->
			<?php if ($linkFacebook != "") { ?>
				<a href="<?php echo $linkFacebook; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/facebook-32x32.png" alt="Facebook" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkTwitter != "") { ?>
				<a href="<?php echo $linkTwitter; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/twitter-32x32.png" alt="Twitter" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkGooglePlus != "") { ?>
				<a href="<?php echo $linkGooglePlus; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/google+-32x32.png" alt="Google Plus" /></a>&nbsp;
			<?php } ?>
			<!-- Musique -->
			<?php if ($linkSpotify != "") { ?>
				<a href="<?php echo $linkSpotify; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/spotify-32x32.png" alt="Spotify" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkMyspace != "") { ?>
				<a href="<?php echo $linkMyspace; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/myspace-32x32.png" alt="MySpace" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkLastfm != "") { ?>
				<a href="<?php echo $linkLastfm; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/lastfm-32x32.png" alt="LastFM" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkGrooveshark != "") { ?>
				<a href="<?php echo $linkGrooveshark; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/smbp/icons/32/grooveshark.png" alt="Grooveshark" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkPandora != "") { ?>
				<a href="<?php echo $linkPandora; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/social_networking_iconpack/pandora_32.png" alt="Pandora" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkRdio != "") { ?>
				<a href="<?php echo $linkRdio; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/rdio-32x32.png" alt="Rdio" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkDeezer != "") { ?>
				<a href="<?php echo $linkDeezer; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/smbp/icons/32/deezer.png" alt="Deezer" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkBandcamp != "") { ?>
				<a href="<?php echo $linkBandcamp; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/smbp/icons/32/bandcamp.png" alt="Bandcamp" /></a>&nbsp;
			<?php } ?>
			<!-- Design / Photo -->
			<?php if ($linkFlickr != "") { ?>
				<a href="<?php echo $linkFlickr; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/flickr-32x32.png" alt="Flickr" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkDribbble != "") { ?>
				<a href="<?php echo $linkDribbble; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/dribbble-32x32.png" alt="Dribbble" /></a>&nbsp;
			<?php } ?>
			<!-- Films -->
			<?php if ($linkImdb != "") { ?>
				<a href="<?php echo $linkImdb; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/imdb-32x32.png" alt="IMdb" /></a>&nbsp;
			<?php } ?>
			<!-- Achats -->
			<?php if ($linkItunes != "") { ?>
				<a href="<?php echo $linkItunes; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/itunes-32x32.png" alt="iTunes" /></a>&nbsp;
			<?php } ?>
			<?php if ($linkAmazon != "") { ?>
				<a href="<?php echo $linkAmazon; ?>" target="_blank"><img src="/wp-content/themes/moustachey/assets/img/links/amazon-32x32.png" alt="Amazon" /></a>&nbsp;
			<?php } ?>
		</div>
	</div>
