...
<div class="article-fixed-meta tubmlog">
    <div class="tumblog-head">
        <div class="tumblog-icon">
            <a href="<?php echo get_post_format_link(get_post_format()); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-tumblog-article.png" width="80" height="80" alt="Article"/></a>
        </div>
    </div>
</div>
<?php }?>
